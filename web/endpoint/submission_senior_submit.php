<?php 
    ...
    $formData = array(
        ...
        'Project Competition Category' => xss_clean($_POST['sub_category']),
        'Name of Project' => xss_clean($_POST['sub_proj1_name']),
        'Abstract of Project' => xss_clean($_POST['sub_proj1_abstract']),
        'Name of Student 1 (in Thai)' => xss_clean($_POST['sub_proj1_std1_name_th']),
        'Name of Student 1 (in English)' => xss_clean($_POST['sub_proj1_std1_name_en']),
        'Email / Telephone Number of Student 1' => xss_clean($_POST['sub_proj1_std1_name_contact']),
        'Name of Student 2 (in Thai)' => xss_clean($_POST['sub_proj1_std2_name_th']),
        'Name of Student 2 (in English)' => xss_clean($_POST['sub_proj1_std2_name_en']),
        'Email / Telephone Number of Student 2' => xss_clean($_POST['sub_proj1_std2_name_contact']),
        'Name of Advisor 1 (in Thai)' => xss_clean($_POST['sub_proj1_adv1_name_th']),
        'Name of Advisor 1 (in English)' => xss_clean($_POST['sub_proj1_adv1_name_en']),
        'Email / Telephone Number of Advisor 1' => xss_clean($_POST['sub_proj1_adv1_name_contact']),
        'Name of Advisor 2 (in Thai)' => xss_clean($_POST['sub_proj1_adv2_name_th']),
        'Name of Advisor 2 (in English)' => xss_clean($_POST['sub_proj1_adv2_name_en']),
        'Email / Telephone Number of Advisor 2' => xss_clean($_POST['sub_proj1_adv2_name_contact']),
    ...
    if ($stmt = $conn->prepare("INSERT INTO senior_submission (id, data, user_id) VALUES (?, ?, ?)")) {
