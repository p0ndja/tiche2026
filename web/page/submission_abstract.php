                ...
                <div class="card">
                    <div class="card-body">
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div class="alert alert-danger w-100">Submission is now closed. Thank you for your interest.</div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sub_fullName" name="sub_fullName" required disabled>
                            </div>
                            <div class="form-group">
                                <label for="sub_affiliation">Affiliation<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="sub_affiliation" name="sub_affiliation" required disabled>
                            </div>
                            <div class="form-group">
                                <label for="sub_email">Email<span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="sub_email" name="sub_email" required disabled>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sub_co_fullName" name="sub_co_fullName" required disabled>
                            </div>
                            <div class="form-group">
                                <label for="sub_co_affiliation">Affiliation<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="sub_co_affiliation" name="sub_co_affiliation" required disabled>
                            </div>
                            <div class="form-group">
                                <label for="sub_co_email">Email<span class="text-danger">*</span></label>
                                <input type="email" class="form-control" id="sub_co_email" name="sub_co_email" required disabled>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sub_title" name="sub_title" required disabled>
                            </div>
                            <div class="form-group">
                                <label for="sub_abstract">Abstract<span class="text-danger">*</span></label>
                                <textarea class="form-control" id="sub_abstract" name="sub_abstract" required disabled rows="5"></textarea>
                            </div>
                            <!-- Category -->
                            <div class="form-group">
                                <label for="sub_category">Category<span class="text-danger">*</span></label>
                                <select class="form-control" id="sub_category" name="sub_category" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="sub_type" name="sub_type" required disabled>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="sub_file" name="sub_file" required disabled accept=".doc,.docx">
                                <span class="text-danger">Accept: .doc, .docx</span>
                            </div>
                            <button type="submit" class="btn btn-danger btn-block" disabled>Submission is now closed</button>
                            <script>
                                // check if all required disabled fields are filled, enable submit button
